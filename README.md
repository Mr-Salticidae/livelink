...
[![下载最新版](https://img.shields.io/badge/⬇️_下载最新版-Windows_安装包-4ade80?style=for-the-badge)](https://github.com/Mr-Salticidae/livelink/releases/latest)
...
> 立项时间：2026-05-12 · 立项人：跳蛛先生 · **当前版本：v1.9.0 · 状态：朋友内测版**
...
| # | 功能 | 状态 |
|---|---|---|
| 5 | 主播弹幕悬浮窗（置顶 / 钉住穿透 / 字体、透明度、颜色、动画与停留时间可调） | ✅ |
| 6 | OBS 弹幕信息板（给观众看，**任意位置拖动** + 完整样式面板与即时预览） | ✅ |
...
| 13 | 直播养宠（哈松币领养 / 投喂 / 观看时长成长 / 3 阶进化 / OBS 底部宠物栏） | ✅ |
...
P2+ 养成+AI   ┃ ✅ 养宠 / DeepSeek AI 回复 / 曼波播报 / 观众端主题
P3 多平台     ┃ ❌ 抖音 / 虎牙适配器
```

详见 `ROADMAP.md`，v1.4.0 变更日志见 `docs/RELEASE_NOTES_v1.4.0.md`。
